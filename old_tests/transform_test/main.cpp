...
const char *vertexShaderSource = R"HERE(#version 300 es
...
const char *fragmentShaderSource = R"HERE(#version 300 es
...
int main() {
    ...
    if (!success)
    {
        ...
        std::cout << "ERROR::SHADER::VERTEX::COMPILATION_FAILED\n" << infoLog << std::endl << glGetString(GL_VERSION) << std::endl;
    }
